                                            ...
                                            <table class="table">
                                                ...
                                                <template v-if="invoiceItem.length">
                                                    <tr v-for="(product,index) in invoiceItem">
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control" readonly v-model="product.in_stock">
                                                        </td>
                                                        <td>
                                                            <div class="input-group mb-3">
                                                                <input type="text" class="form-control"
                                                                       aria-label="Recipient's username"
                                                                       aria-describedby="basic-addon2" v-model="product.quantity"
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control" readonly v-model="product.total_price">
                                                        </td>
                                                        <td>
...
export default {
    ...
    methods: {
        ...
        addProduct(selectedValue) {
            ...
            this.invoiceItem.sub_total = this.subTotal();
        },
        ...
        setQuantityTotalPrice(product,index,productFound=false){
            ...
            if(productFound){
                ...
                this.invoiceItem[index].total_price = total_price;
            }else{
                // set price and quantity
                this.invoiceItem[index].quantity = product.quantity;
                let total_price = product.quantity * product.price;
                this.invoiceItem[index].total_price = total_price;
            }
            this.invoiceItem.sub_total = this.subTotal();
        },
